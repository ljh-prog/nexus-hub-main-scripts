...
Themes = {
    ...
    Dark = {
        ...
        Panel=Color3.fromRGB(20,20,20), Row=Color3.fromRGB(28,28,28), RowHover=Color3.fromRGB(42,42,42),
        Accent=Color3.fromRGB(230,230,230), AccentLight=Color3.fromRGB(255,255,255),
        Green=Color3.fromRGB(200,200,200), Red=Color3.fromRGB(180,180,180), Red2=Color3.fromRGB(220,220,220),
        Text=Color3.fromRGB(255,255,255), Dim=Color3.fromRGB(160,160,160), Stroke=Color3.fromRGB(55,55,55),
        SoftButton=Color3.fromRGB(30,30,30), SoftButtonHover=Color3.fromRGB(48,48,48),
        SoftAccent=Color3.fromRGB(40,40,40), SoftAccentHover=Color3.fromRGB(58,58,58),
        ToggleOff=Color3.fromRGB(32,32,32), ToggleOff2=Color3.fromRGB(32,32,32),
        InputBg=Color3.fromRGB(22,22,22), SliderBg=Color3.fromRGB(55,55,55),
        BlacklistHover=Color3.fromRGB(70,70,70), BlacklistLeave=Color3.fromRGB(38,38,38),
    }
}
Theme = {}
...
function makeMainPanel(t,size,pos) local f=Instance.new("Frame"); f.Size=size; f.Position=pos; f.BackgroundColor3=Theme.MainBackground; f.BackgroundTransparency=0.25; f.BorderSizePixel=0; f.ClipsDescendants=true; f.Parent=gui; corner(f,10); addOutline(f)
    local sidebar=Instance.new("Frame"); sidebar.Size=UDim2.new(0,140,1,0); sidebar.Position=UDim2.new(0,0,0,0); sidebar.BackgroundColor3=Theme.Panel; sidebar.BackgroundTransparency=0.15; sidebar.BorderSizePixel=0; sidebar.Parent=f; corner(sidebar,10)
    ...
    local logoFrame=Instance.new("Frame"); logoFrame.Size=UDim2.new(0,50,0,50); logoFrame.Position=UDim2.new(0.5,-25,0,12); logoFrame.BackgroundColor3=Theme.SoftAccent; logoFrame.BorderSizePixel=0; logoFrame.Parent=sidebar; corner(logoFrame,8)
    ...
    local sbDiv=Instance.new("Frame"); sbDiv.Size=UDim2.new(1,-20,0,1); sbDiv.Position=UDim2.new(0,10,0,72); sbDiv.BackgroundColor3=Theme.Accent; sbDiv.BackgroundTransparency=0.4; sbDiv.BorderSizePixel=0; sbDiv.Parent=sidebar
    local sbScroll=Instance.new("ScrollingFrame"); sbScroll.Size=UDim2.new(1,-8,1,-82); sbScroll.Position=UDim2.new(0,4,0,78); sbScroll.BackgroundTransparency=1; sbScroll.BorderSizePixel=0; sbScroll.ScrollBarThickness=2; sbScroll.ScrollBarImageColor3=Theme.Accent; sbScroll.CanvasSize=UDim2.new(0,0,0,0); sbScroll.Active=true; sbScroll.Parent=sidebar
    ...
    local body=Instance.new("ScrollingFrame"); body.Size=UDim2.new(1,-148,1,-12); body.Position=UDim2.new(0,144,0,6); body.BackgroundTransparency=1; body.BorderSizePixel=0; body.ScrollBarThickness=3; body.ScrollBarImageColor3=Theme.Accent; body.CanvasSize=UDim2.new(0,0,0,0); body.Active=true; body.Parent=f
    ...
    makeResizable(f, UDim2.new(0, 380, 0, 300), t)
...
-- CREATE PANELS
main,mainBody=makeMainPanel("Nexus Private",UDim2.new(0,520,0,480),UDim2.new(0.5,-260,0.5,-255))
main.Visible = false
...
local tabIcons={["Keybinds"]="rbxassetid://81106531045025",["Auto TP"]="rbxassetid://81106531045025",["ESP"]="rbxassetid://81106531045025",["UI"]="rbxassetid://81106531045025",["Priority"]="rbxassetid://81106531045025",["Performance"]="rbxassetid://81106531045025"}
local _sbScroll=_G._mainSidebarScroll
if _sbScroll then
    for _,tabName in ipairs(tabs) do
        local btn=Instance.new("TextButton"); btn.Size=UDim2.new(1,-4,0,32); btn.BackgroundColor3=Color3.fromRGB(30,80,160); btn.BackgroundTransparency=0.1; btn.BorderSizePixel=0; btn.Text=""; btn.AutoButtonColor=true; btn.Parent=_sbScroll; corner(btn,6)
        local sbStroke2=Instance.new("UIStroke"); sbStroke2.Color=Color3.fromRGB(255,255,255); sbStroke2.Thickness=0.5; sbStroke2.Transparency=0.3; sbStroke2.ApplyStrokeMode=Enum.ApplyStrokeMode.Border; sbStroke2.Parent=btn
        local icon=Instance.new("ImageLabel"); icon.Size=UDim2.new(0,18,0,18); icon.Position=UDim2.new(0,8,0.5,-9); icon.BackgroundTransparency=1; icon.Image=tabIcons[tabName] or ""; icon.Parent=btn
        local label=Instance.new("TextLabel"); label.Size=UDim2.new(1,-34,1,0); label.Position=UDim2.new(0,30,0,0); label.BackgroundTransparency=1; label.Text=tabName; label.TextColor3=Color3.fromRGB(255,255,255); label.Font=Enum.Font.GothamBold; label.TextSize=11; label.TextXAlignment=Enum.TextXAlignment.Left; label.Parent=btn
...
function loadTab(tabName)
    ...
    for name,btn in pairs(tabButtons) do btn.BackgroundColor3=name==tabName and Color3.fromRGB(45,120,220) or Color3.fromRGB(30,80,160) end
    ...
    elseif tabName=="UI" then
        ...
        local rb=makeMainButton(mainBody,"Reset UI",function()
            main.Position=UDim2.new(0.5,-260,0.5,-255); panels["Invisible Steal Panel"].Position=UDim2.new(0,80,0.5,-220)
...
local dc=Instance.new("TextLabel"); dc.Size=UDim2.new(0,110,0,26); dc.Position=UDim2.new(0,230,0,5); dc.BackgroundTransparency=1; dc.Text=".gg/NexusHub"; dc.TextColor3=Color3.fromRGB(255,215,0); dc.Font=Enum.Font.GothamBold; dc.TextSize=16; dc.TextXAlignment=Enum.TextXAlignment.Left; dc.Parent=bottomBar; local dcGrad=Instance.new("UIGradient"); dcGrad.Color=ColorSequence.new({ColorSequenceKeypoint.new(0,Color3.fromRGB(255,180,0)),ColorSequenceKeypoint.new(0.3,Color3.fromRGB(255,235,150)),ColorSequenceKeypoint.new(0.5,Color3.fromRGB(255,255,220)),ColorSequenceKeypoint.new(0.7,Color3.fromRGB(255,235,150)),ColorSequenceKeypoint.new(1,Color3.fromRGB(255,180,0))}); dcGrad.Rotation=45; dcGrad.Parent=dc; task.spawn(function() while true do for i=0,200 do dcGrad.Offset=Vector2.new(-1+i/100,-1+i/100); task.wait(0.01) end; task.wait(0.3) end end)
